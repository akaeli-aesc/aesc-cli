...
from aesc.tools.web.fetch import FetchURL, Params

# Every test here performs a live HTTP fetch (and the basic test pins an exact
# snapshot of a remote page, which drifts). Deselected by default; run with
