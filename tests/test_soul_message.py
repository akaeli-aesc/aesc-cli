...
from aesc.provider import ToolError, ToolOk, ToolResult
from aesc.provider.message import ImageURLPart, Message, TextPart
from aesc.soul.message import (
    check_message,
    system,
...
def test_check_message_with_think_and_think_capability():
    ...
    from aesc.provider.message import ThinkPart
