    ...
    assert bash_tool.base.parameters == snapshot(
        {
            "properties": {
                ...
                "timeout": {
                    "anyOf": [
                        {"maximum": 600, "minimum": 1, "type": "integer"},
                        {"type": "null"},
                    ],
                    "default": None,
                    "description": "The timeout in seconds for the command to execute. If the command takes longer than this, it will be killed. If not specified, network scanning tools (nmap, nikto, etc.) automatically get 5 minutes, other commands get 60 seconds.",
                },
            },
            "required": ["command"],
            "type": "object",
