...
from aesc.provider import JsonType
from aesc.utils.string import shorten_middle
...
def extract_key_argument(
    json_content: str | streamingjson.Lexer | None, tool_name: str
) -> str | None:
    # Handle None or empty arguments (e.g., during streaming)
